class ApplicationController < ActionController::Base
  ...
  after_action :verify_authorized, except: [:dashboard, :demandes], unless: :skip_pundit?
  after_action :verify_policy_scoped, only: [:dashboard, :demandes], unless: :skip_pundit?
